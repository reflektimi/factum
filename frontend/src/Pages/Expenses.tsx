...
import { Plus, Search, Receipt, MoreVertical, Edit2, Trash2, ExternalLink, Tag } from 'lucide-react';
import type { PaginatedData, Expense } from '@/types/models';
...
export default function Expenses() {
    ...
    const [expenses, setExpenses] = useState<PaginatedData<Expense> | null>(null);
    ...
    return (
        <AuthenticatedLayout>
                            ...
                            <TableRow>
                                <TableCell colSpan={7} className="py-20 text-center">
                                    <div className="flex items-center justify-center gap-2 text-slate-400 font-medium animate-pulse">
                                        ...
                                        <span>Auditing expenditures...</span>
                                    </div>
                                </TableCell>
                            </TableRow>
                                        ...
                                        <TableActions>
                                            <Dropdown>
                                                ...
                                                <Dropdown.Content align="right" width="48">
                                                    <Dropdown.Link to={`/expenses/${expense.id}`} className="flex items-center gap-2 text-sm">
                                                        <ExternalLink className="w-4 h-4 opacity-50" />
                                                        Verify Entry
                                                    </Dropdown.Link>
                                                    <Dropdown.Link to={`/expenses/${expense.id}/edit`} className="flex items-center gap-2 text-sm">
            ...
            {expenses && <Pagination data={expenses} />}
