...
import type { PaginatedData, User } from '@/types/models';
import { Search, Trash2, Edit2, UserPlus, Shield, MoreVertical, Loader2 } from 'lucide-react';
...
export default function Users() {
    ...
    const submitCreate: FormEventHandler = async (e) => {
        e.preventDefault();
        setProcessing(true);
        setErrors({});
        try {
    ...
    const handleDelete = async () => {
        ...
        setIsDeleting(true);
        try {
            await api.delete(`/api/users/${isDeletingId}`);
