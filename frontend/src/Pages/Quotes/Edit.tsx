...
import { Save, Plus, Trash2, ArrowLeft, Calculator, FileText, UserPlus, Calendar, Activity, AlertCircle, CheckCircle2, Clock } from 'lucide-react';
import type { Account, Quote } from '@/types/models';
        ...
        return (
            <AuthenticatedLayout>
                <div className="flex h-[60vh] items-center justify-center">
                    <div className="text-slate-500 animate-pulse font-medium">Rebinding quote context...</div>
                </div>
            </AuthenticatedLayout>
        );
    }
                ...
                title={
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 font-mono text-xl font-medium">#{quote.number}</span>
                        </div>
                    </div>
                }
