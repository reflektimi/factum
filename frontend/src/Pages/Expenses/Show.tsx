...
import { ArrowLeft, Edit2, Trash2, FileText, DollarSign, Calendar, Tag, Store, Image as ImageIcon, ExternalLink, ShieldCheck, History, CheckCircle2, Activity, Send } from 'lucide-react';
import type { Expense, ActivityLog } from '@/types/models';
...
export default function Show() {
    ...
    const [expense, setExpense] = useState<(Expense & { activity_logs?: ActivityLog[] }) | null>(null);
        ...
        return (
            <AuthenticatedLayout>
                <div className="flex h-[60vh] items-center justify-center">
                    <div className="text-slate-500 animate-pulse font-medium">Loading disbursement evidence...</div>
                </div>
            </AuthenticatedLayout>
        );
    }
