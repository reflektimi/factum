...
export default function Edit() {
    ...
    useEffect(() => {
        const fetchExpense = async () => {
            try {
                ...
                const expense: Expense = response.data.expense;
                setData({
        ...
        return (
            <AuthenticatedLayout>
                <div className="flex h-[60vh] items-center justify-center">
                    <div className="text-slate-500 animate-pulse font-medium">Retrieving disbursement record...</div>
                </div>
            </AuthenticatedLayout>
        );
    }
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Disbursement #${id}`} />
                ...
                title={
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 font-mono text-lg font-medium">#{id}</span>
                        </div>
                    </div>
                }
                subtitle={`Adjusting disbursement details for ${data.merchant || 'unspecified merchant'}`}
            />
                            ...
                            <CardContent className="p-6 space-y-8">
                                ...
                                <div className="space-y-4 pt-4 border-t border-slate-100">
                                    ...
                                    <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 text-[11px] text-slate-500 font-medium leading-relaxed">
                                        This expense was originally recorded. Updates will be reflected in current period financial reports. 
                                    </div>
                                </div>
