...
import { FileText, Calculator, Calendar, Activity, CheckCircle2 } from 'lucide-react';
                ...
                title={
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-400 font-mono text-lg font-medium">{recurringInvoice.profile_name}</span>
                        </div>
                    </div>
                }
                            ...
                            <div className="col-span-12 lg:col-span-4 relative">
                                <div className="lg:sticky lg:top-6 space-y-6">
                                    ...
                                    <div className="mt-6 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 border-dashed text-center">
                                        <CheckCircle2 className="w-8 h-8 text-primary-500 mx-auto mb-3" />
