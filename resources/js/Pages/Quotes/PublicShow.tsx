...
import { Quote, Setting } from '@/types/models';
...
export default function PublicShow({ quote, settings }: PublicShowProps) {
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="flex justify-between items-center sm:px-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="primary" icon={<Download className="w-4 h-4" />}>PDF Download</Button>
                    </div>
                </div>
                        ...
                        <div className="p-8 md:p-12 space-y-12">
                            ...
                            <div className="flex flex-col md:flex-row gap-12 justify-between items-end pt-8">
                                <div className="w-full max-w-[280px]">
                                    <Button variant="primary" fullWidth size="lg" icon={<CheckCircle2 className="w-5 h-5" />} className="shadow-lg shadow-primary-200">
                                        Accept Quotation
                                    </Button>
                                </div>
                ...
                <div className="text-center">
                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Document Registry: {quote.id}-{Date.now()}</p>
                </div>
            </div>
        </div>
    );
