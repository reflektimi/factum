...
import { ArrowLeft, Printer, CheckCircle, FileText, Hash, CreditCard, User, Calculator, ShieldCheck, ExternalLink, Calendar } from 'lucide-react';
                ...
                title={
                    <div className="flex items-center gap-3">
                        <Link 
                            ...
                            className="p-2 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-primary-600 hover:border-primary-100 hover:bg-primary-50/50 transition-all shadow-sm group print:hidden"
                        >
                    ...
                    <Card className="border-none shadow-premium-soft overflow-hidden print:shadow-none print:bg-white">
                        ...
                        <CardContent className="p-12 space-y-12">
                            ...
                            <div className="text-center space-y-4">
                                <div className="mx-auto w-20 h-20 bg-emerald-50 text-emerald-600 rounded-3xl flex items-center justify-center mb-6 shadow-sm border border-emerald-100 animate-in zoom-in-75 duration-700">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Link 
                                                ...
                                                className="group inline-flex items-center gap-1.5 font-bold text-primary-600 hover:text-primary-700 transition-colors"
                                            >
